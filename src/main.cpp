...
#if defined(NDEBUG)
# error "ShardScrypt cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x892a73705fba34d8536b492f5f055ac61cff515bd733a9ce9d62cf6b1f963dc7");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // ShardScrypt: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ShardScrypt Signed Message:\n";
...
{
    // ShardScrypt: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // ShardScrypt: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // ShardScrypt: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // ShardScrypt: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ShardScrypt: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // ShardScrypt: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x892a73705fba34d8536b492f5f055ac61cff515bd733a9ce9d62cf6b1f963dc7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Life begins anew";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ShardScrypt: increase each by adding 2 to bitcoin's value.
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    RenameThread("shardscrypt-miner");
